  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Social Feed Grid - Equal Height Layout */}
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-gray-200 rounded-lg h-64 overflow-hidden relative group cursor-pointer hover:shadow-lg transition-all duration-300">
            ...
            />
            <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm rounded-full p-2 opacity-80 group-hover:opacity-100 transition-opacity duration-200">
